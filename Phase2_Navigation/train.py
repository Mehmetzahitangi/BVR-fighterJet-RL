...
if __name__ == "__main__":
    ...
    models_dir = "./fighter_checkpoints/phase2/"
    logs_dir = "./fighter_tensorboard/phase2/"
    ...
    LOAD_MODEL_PATH = f"{models_dir}sac_f16_phase2_{CHECKPOINT_STEP}_steps.zip"
    LOAD_VEC_PATH = f"{models_dir}sac_f16_phase2_{CHECKPOINT_STEP}_steps_vec_normalize.pkl"
    ...
    try:
        model.learn(
            ...
            tb_log_name="Phase2_300K"
        )
    except KeyboardInterrupt:
        print("\n Eğitim  durduruldu. (Ctrl+C)")

    print("Eğitim tamamlandı/durduruldu. Son veriler kaydediliyor...")
    model.save(f"{models_dir}/sac_fighter_phase2_final.zip")
    norm_env.save(f"{models_dir}/sac_fighter_phase2_final_vec_normalize.pkl")
